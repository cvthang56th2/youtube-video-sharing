...
const Popup = ({ width, isShow, title = 'Popup', saveText = 'Save', cancelText = 'Cancel', wrapperClasses = '', ...props }: PropsType) => {
  return (
    <div className={["w-screen h-screen fixed inset-0 z-10 overflow-y-auto flex items-center justify-center", isShow ? 'bg-[rgba(0,0,0,0.2)]' : 'pointer-events-none', wrapperClasses].join(' ')}>
